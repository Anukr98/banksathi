...
export default function FourSteps() {
  const Steps = [
    {
      heading: strings.four_steps.step_1.heading,
      detail: strings.four_steps.step_1.detail,
    },
    {
      heading: strings.four_steps.step_2.heading,
      detail: strings.four_steps.step_2.detail,
    },
    {
      heading: strings.four_steps.step_3.heading,
      detail: strings.four_steps.step_3.detail,
    },
    {
      heading: strings.four_steps.step_4.heading,
      detail: strings.four_steps.step_4.detail,
    },
  ];
  return (
      ...
      <div className={styles.fourstep_container}>
        ...
        <div className={styles.second}>
          <div className={styles.fourstep_steps_design}>
            {[
              <FaRupeeSign color={"#fffff"} key={"1"} />,
              <IoPeople color={"#fffff"} key={"2"} />,
              <FaRupeeSign color={"#fffff"} key={"3"} />,
              <FaRupeeSign color={"#fffff"} key={"4"} />,
            ].map((item, index) => {
              return (
