        ...
        <div className={styles.header_containor}>
          <div className={styles.header_left_part}>
            ...
            <div className={styles.menu_items_wrap}>
              {menu.map((item, index) => {
                return (
                  <li className={styles.menu_item} key={index.toString()}>
                    {item.name}
                  </li>
                );
              })}
          ...
          <div
            className="md:hidden  visible p-1 bg-secondary w-fit relative"
      ...
      {open ? (
        <div className="flex relative  w-screen h-screen bg-white z-10 top-[-4rem]  justify-between px-16 py-8">
          <div className="flex flex-col ">
            {ResponsiveMenu.map((item, index) => {
              return (
                <li
                  key={index.toString()}
                  className="flex flex-col text-[15px] font-semibold text-[#555555] pb-2"
                >
                  {item}
                </li>
              );
          ...
          <div
            ...
            className="p-1 bg-secondary w-fit h-fit flex"
          >
